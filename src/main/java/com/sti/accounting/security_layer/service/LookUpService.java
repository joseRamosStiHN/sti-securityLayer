...
import com.sti.accounting.security_layer.dto.PermissionDto;
import com.sti.accounting.security_layer.dto.RoleDto;
...
public class LookUpService {
    ...
    public List<KeyValueDto> getRoles() {
        ...
        return roleRepository.findAll().stream()
                .map(role -> new KeyValueDto(role.getId(), role.getRoleName(), role.getRoleDescription(), role.getIsGlobal())).toList();
    }
